...
```{r}
  # Store data matrices
  fname = sprintf("/Users/martin/Desktop/dispersions/dispersions_ncon-%d_cdx.tab", conditions)
  write.table(est.cdx, fname, row.names = FALSE, col.names = FALSE)
  fname = sprintf("/Users/martin/Desktop/dispersions/dispersions_ncon-%d_dex.tab", conditions)
  write.table(est.dex, fname, row.names = FALSE, col.names = FALSE)
